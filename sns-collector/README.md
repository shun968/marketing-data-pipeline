...
0 */3 * * * /home/shun-asai/dev/github/marketing-data-pipeline/sns-collector/scripts/cron_run.sh bluesky
# YouTubeキーワード検索(3時間おき、Blueskyと15分ずらして負荷分散)
15 */3 * * * /home/shun-asai/dev/github/marketing-data-pipeline/sns-collector/scripts/cron_run.sh youtube
```
