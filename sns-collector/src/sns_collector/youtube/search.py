...
def _run_with_db(config: YouTubeConfig, data_dir: Path, conn) -> None:
    ...
    for keyword in config.keywords:
        ...
        for item in items:
            ...
            if video.video_id in run_seen or video.video_id in seen:
                skip_count += 1
                continue
        ...
        if new_videos:
            ...
            insert_records(conn, "youtube", records)
